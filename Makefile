...
OBJS = main.o syscalls.o sysmem.o startup.o system.o i2c.o uart.o timer.o delay.o
SUS = syscalls.su sysmem.su system.su main.su i2c.su uart.su timer.su delay.su
...
timer.o: Src/driver/timer.c
	$(CC) $(CFLAGS) $(INCLUDE) -c Src/driver/timer.c -o timer.o
delay.o: Src/lib/delay.c
	$(CC) $(CFLAGS) $(INCLUDE) -c Src/lib/delay.c -o delay.o
startup.o: $(STARTUP)
